    ...
    return [
      {
        ...
        headers: [
          ...
          { key: "Permissions-Policy", value: "camera=(), microphone=(), geolocation=()" },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://sandbox-cdn.paddle.com https://cdnjs.cloudflare.com https://public.profitwell.com",
              "script-src-elem 'self' 'unsafe-inline' https://sandbox-cdn.paddle.com https://cdnjs.cloudflare.com https://public.profitwell.com",
